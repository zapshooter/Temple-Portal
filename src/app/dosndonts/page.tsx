  ...
  return (
    <div className="container">
      ...
      <section className="introduction">
        <h2>Introduction</h2>
        <p>
          Fasting, or *Vrat*, is an integral part of Hindu spirituality and culture. Observed to seek blessings, spiritual growth, and self-discipline, vrats come with specific guidelines to enhance their sanctity and benefits. Here is a concise guide to the Dos and Don'ts to observe during fasts.
        </p>
      </section>
